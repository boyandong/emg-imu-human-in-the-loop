...
| F7_SPD_tangent_candidate | candidate_api_native_unavailable | 2H+2 | Frozen source-fitted F2c log-tangent reference; calibration-only class prototypes and Frobenius-equivalent tangent Euclidean distances. Synthetic matrix oracle passes; native held-out incremental value, affine-invariant geodesic, historical family equivalence and own-device validity remain unproven. |
