...
class WindowedEmgDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx: int) -> dict[str, torch.Tensor]:
        ...
        # Identify the task from the HDF5 metadata rather than its path. Custom
        # datasets do not necessarily include the task name in their folders.
        is_discrete_gestures = self.emg_recording.task == "discrete_gestures"
